    ...
    if (selectedQuality) {
      try {
        ...
        const content = {
          ...
          caption: `*DOWNLOADED BY DEXTER-MD*`,
          contextInfo: {
            externalAdReply: {
        ...
        console.error("❗️Error fetching video details:", error);
        m.reply(`❗️Error fetching video details: ${error.message}`);
      }
    }
  }
};
